...
app.initEvents = function() {
    ...
    el2 = document.getElementById("id_btn2");
    el2.addEventListener(evt, myEventHandler2, false);

    el3 = document.getElementById("id_btn3");
    el3.addEventListener(evt, myEventHandler3, false);

    
    el4 = document.getElementById("id_btn4");
    el4.addEventListener(evt, myEventHandler4, false);
